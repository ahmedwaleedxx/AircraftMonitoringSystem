 ...
 * @author ahmedwaleed
 */
public class Pressure_Dial extends JComponent implements Dial_Interface {
    ...
    public View_Plane planeGUI;
    boolean isRunning = true;

    public Pressure_Dial(View_Plane planeGUI) {
        this.planeGUI = planeGUI;
    }

    public Pressure_Dial() {
    ...
    public void paint(Graphics grphcs) {
        ...
        drawText(g2, centerX, centerY + 30, angleSize);
        super.paint(grphcs);
    }

    @Override
    public void drawText(Graphics2D g2, float x, float y, float size) {
        g2.setColor(getForeground());
        float max = maximum;
        float v = getValueFixed();
        float n = v / max * 100f;
        String text = String.valueOf((int) n) + " Pa";
